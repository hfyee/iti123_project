...
research_task = Task(
    description=(
        """ Conduct a thorough research on the latest trends in the consumer good market mentioned in {question}.
...
analysis_task = Task(
    description=(
        """Analyze the research findings and create a market report.
            ...
            2. Identify the top 2 players in this space, their positioning, reach, and ratings
            3. Identify potential market gaps and any emerging players
